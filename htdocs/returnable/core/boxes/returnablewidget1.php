...
/**
 * \file    modulebuilder/template/core/boxes/returnablewidget1.php
 * \ingroup returnable
 * \brief   Widget provided by Returnable
 *
 ...
 */
class returnablewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "returnablebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "returnable@returnable";
	 ...
	 */
	public $depends = array('returnable');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->returnable->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/returnable/class/returnable.class.php";

		// Populate the head at runtime
		$text = $langs->trans("ReturnableBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_returnable@returnable',
