...
dol_include_once("/returnable/class/myobject.class.php");


/**
 * mailing_mailinglist_returnable
 */
class mailing_mailinglist_returnable_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_returnable_myobject';
	...
	var $picto='returnable@returnable';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('returnable',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/returnable/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_returnable_myobject.modules.php: mailing ".$num." targets found");
