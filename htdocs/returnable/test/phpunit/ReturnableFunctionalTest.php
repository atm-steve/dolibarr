...
/**
 * \file    test/functional/ReturnableFunctionalTest.php
 * \ingroup returnable
...
/**
 * Class ReturnableFunctionalTest
 *
 ...
 *
 * @package Testreturnable
 */
class ReturnableFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modReturnable')->click();
		} else {
			// Disable the module
			$this->byHref('modReturnable')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/returnable/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('returnable/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/returnable/admin/about.php');
		$this->authenticate();
		return $this->assertContains('returnable/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('returnablewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReturnable_ReturnableTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReturnable_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
