...
/**
 *	\file       htdocs/returnable/template/returnableindex.php
 *	\ingroup    returnable
 *	\brief      Home page of returnable top menu
 */
...
$langs->loadLangs(array("returnable@returnable"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->returnable->read) accessforbidden();
...
llxHeader("",$langs->trans("ReturnableArea"));

print load_fiche_titre($langs->trans("ReturnableArea"),'','returnable.png@returnable');
...
// Draft MyObject
if (! empty($conf->returnable->enabled) && $user->rights->returnable->read)
{
	$langs->load("orders");
