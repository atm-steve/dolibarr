...
/**
 *  \file       skilldet_note.php
 *  \ingroup    hrmtest
 *  \brief      Tab for notes on Skilldet
 */
...
$hookmanager->initHooks(array('skilldetnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Skilldet'), $help_url);
