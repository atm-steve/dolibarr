...
$permissiontoadd = $user->rights->hrm->position->write; // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
...
if ($object->id) {
	...
	$permissiontoadd = 1;
	//$permtoedit = $user->rights->hrm->position->write;
	$permtoedit = 1;
	$param = '&id='.$object->id;
