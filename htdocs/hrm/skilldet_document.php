...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->hrmtest->multidir_output[$object->entity ? $object->entity : $conf->entity]."/skilldet/".get_exdir(0, 0, 0, 1, $object);
}

$permissiontoadd = $user->rights->hrmtest->skilldet->write; // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
...
if ($object->id) {
	...
	$permissiontoadd = 1;
	//$permtoedit = $user->rights->hrmtest->skilldet->write;
	$permtoedit = 1;
	$param = '&id='.$object->id;
