...
$permissiontoadd = $user->rights->hrm->skill->write; // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
...
if ($object->id) {
	...
	$modulepart = 'hrm';
	//$permissiontoadd = $user->rights->hrm->skill->write;
	$permissiontoadd = 1;
	//$permtoedit = $user->rights->hrm->skill->write;
	$permtoedit = 1;
	$param = '&id='.$object->id;
