...
class Account extends CommonObject
{
	...
	function useDetailedBBAN()
	{
		...
		if (in_array($country_code,array('DE','FR','ES','GA','IT'))) return 1; // France, Spain, Gabon, ...
		if (in_array($country_code,array('AU','BE','CA','DK','GR','GB','ID','IE','IR','KR','NL','NZ','UK','US'))) return 2;      // Australia, England...
		return 0;
	}
