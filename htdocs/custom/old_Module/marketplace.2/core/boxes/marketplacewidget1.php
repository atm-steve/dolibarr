...
/**
 * \file    modulebuilder/template/core/boxes/marketplacewidget1.php
 * \ingroup marketplace
 * \brief   Widget provided by Marketplace
 *
 ...
 */
class marketplacewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "marketplacebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "marketplace@marketplace";
	 ...
	 */
	public $depends = array('marketplace');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->marketplace->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/marketplace/class/marketplace.class.php";

		// Populate the head at runtime
		$text = $langs->trans("MarketplaceBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_marketplace@marketplace',
