...
/**
 * \file    test/functional/MarketplaceFunctionalTest.php
 * \ingroup marketplace
...
/**
 * Class MarketplaceFunctionalTest
 *
 ...
 */
class MarketplaceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMarketplace')->click();
		} else {
			// Disable the module
			$this->byHref('modMarketplace')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/marketplace/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('marketplace/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/marketplace/admin/about.php');
		$this->authenticate();
		return $this->assertContains('marketplace/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('marketplacewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMarketplace_MarketplaceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMarketplace_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
