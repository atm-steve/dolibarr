 ...
 */
class serverobserverbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "serverobserver@serverobserver";
    public $boxlabel;
    public $depends = array("serverobserver");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/serverobserver/class/serverobserver.class.php";
