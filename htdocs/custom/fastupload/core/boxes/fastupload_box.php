 ...
 */
class fastuploadbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "fastupload@fastupload";
    public $boxlabel;
    public $depends = array("fastupload");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/fastupload/class/fastupload.class.php";
