...
if (! $sortfield) $sortfield = "sp.date_valid";
...
if ($id > 0 || ! empty($ref))
{
    ...
    if ($result > 0)
    {
        ...
        {
            $sql = "SELECT DISTINCT s.nom as name, s.rowid as socid, sp.rowid as propalid, sp.ref, d.total_ht as amount,";
            //$sql .= " sp.ref_client,";
            $sql .= "sp.date_valid, sp.fk_statut as statut, d.rowid, d.qty";
        ...
        if ($result)
        {
            ...
            print_barre_liste($langs->trans("SupplierProposals"), $page, $_SERVER["PHP_SELF"], "&amp;id=$product->id", $sortfield, $sortorder, '', $num, $totalrecords, '');
            ...
            print_liste_field_titre("Ref", $_SERVER["PHP_SELF"], "sp.rowid", "", $option, '', $sortfield, $sortorder);
            print_liste_field_titre("Company", $_SERVER["PHP_SELF"], "s.nom", "", $option, '', $sortfield, $sortorder);
            print_liste_field_titre("DatePropal", $_SERVER["PHP_SELF"], "sp.date_valid", "", $option, 'align="center"', $sortfield, $sortorder);
            print_liste_field_titre("Qty", $_SERVER["PHP_SELF"], "d.qty", "", $option, 'align="center"', $sortfield, $sortorder);
            print_liste_field_titre("AmountHT", $_SERVER["PHP_SELF"], "sp.total", "", $option, 'align="right"', $sortfield, $sortorder);
            print_liste_field_titre("Status", $_SERVER["PHP_SELF"], "sp.fk_statut", "", $option, 'align="right"', $sortfield, $sortorder);
            print "</tr>\n";
            if ($num > 0)
            {
                $var = True;
                while ($i < $num && $i < $conf->liste_limit)
                {
                    ...
                    print dol_print_date($db->jdate($objp->date_valid)) . "</td>";
