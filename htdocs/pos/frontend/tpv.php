           ...
           <!-- FIN berni -->
			...
			<div class="options">
				<ul>
					...
					<input onclick="this.select()" type="text" size="6" name="line_quantity" id="line_quantity" value="0"  class="quertyKeyboard"></li>
					<br clear="all" />
		...
		<div id="idCashMode" class="leftBlock bloqueOpciones" style="display:none" title="<?php echo $langs->trans("CloseCash"); ?>">
          ...
          <!--   <div class="but barcode">
               ...
               <div class="inputs" style="width:100% !important;">
               		...
               		<div style="width:100%; height:65px; border: 0"  >

	                    <div class="tabContainer0" style="width:35%;margin-right:5px;">
		                    <!-- <label>
	                    ...
	                    <div class="tabContainer1" style="width:35%;margin-right:5px;" >
	                       <?php }   else{?>
	                    <div class="tabContainer1" style="width:54%;margin-right:5px;" >
	                     <?php }   ?>
