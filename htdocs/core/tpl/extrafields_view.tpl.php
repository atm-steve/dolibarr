	...
	foreach ($extrafields->attributes[$object->table_element]['label'] as $key => $label)
	{
		...
		else
		{
			...
			if (($object->statut == 0 || ! empty($extrafields->attributes[$object->table_element]['alwayseditable'][$key]))
				/* ———————————— SPÉ NAUVICA { ———————————— */
				&& !is_numeric($extrafields->attributes[$object->table_element]['alwayseditable'][$key]) // prevent the possibility of modifying extrafields previously set to "not editable"
				/* ———————————— SPÉ NAUVICA } ———————————— */
