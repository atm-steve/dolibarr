...
{
?>
	<div class="center login_main_home paddingtopbottom <?php echo empty($conf->global->MAIN_LOGIN_BACKGROUND)?'':' backgroundsemitransparent'; ?>" style="max-width:80%; background-color:#cfd6e5; background-color:rgba(207, 214, 229, 0.5);padding:20px;border-radius:10px;">
	<?php echo $main_home; ?>
	</div><br>
<?php
}
