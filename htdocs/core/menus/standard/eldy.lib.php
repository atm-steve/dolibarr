	...
	if ($mainmenu)
	{
		...
		if ($mainmenu == 'commercial')
		{
			...
			if (! empty($conf->propal->enabled))
			{
				...
				if ($usemenuhider || empty($leftmenu) || $leftmenu=="propals") $newmenu->add("/comm/propal/list.php?leftmenu=propals&viewstatut=5", $langs->trans("PropalStatusNotFeasible"), 2, $user->rights->propale->lire);
