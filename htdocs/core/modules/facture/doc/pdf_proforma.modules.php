...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_proforma.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from proforma model
 */
...
/**
 *	Class to manage PDF invoice template proforma
 */
class pdf_proforma extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->MultiCell($w, 3, "FACTURE PROFORMA", '', 'R');
