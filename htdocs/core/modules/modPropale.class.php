...
class modPropale extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->export_sql_end[$r] .=' LEFT JOIN '.MAIN_DB_PREFIX.'c_input_reason ir ON (c.fk_input_reason=ir.rowid) ';
