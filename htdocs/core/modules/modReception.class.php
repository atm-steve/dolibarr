...
class modReception extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->export_sql_end[$r] .=' LEFT JOIN '.MAIN_DB_PREFIX.'element_element as eec ON (eec.fk_target = c.rowid AND sourcetype = "order_supplier" AND targettype = "reception")';
		$this->export_sql_end[$r] .=' LEFT JOIN '.MAIN_DB_PREFIX.'commande_fournisseur as cof ON eec.fk_source= cof.rowid,';
