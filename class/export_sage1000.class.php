...
class TExportComptaSage1000 extends TExportCompta {
    function __construct(&$db, $exportAllreadyExported=false, $addExportTime=false) {
        ...
        $this->_format_ecritures_comptables_vente = array(
            array('name' => 'id_societe',			'length' => 6,	'default' => '',	'type' => 'numeric'),
            array('name' => 'code_journal',			'length' => 3,	'default' => 'VTE',	'type' => 'text'),
            ...
            array('name' => 'numero_tiers',         'length' => 17,	'default' => '',	'type' => 'text'),
            array('name' => 'fixe_X',               'length' => 1,	'default' => 'X',	'type' => 'text'),
            array('name' => 'montant',		        'length' => 20,	'default' => '0',	'type' => 'text'),
            array('name' => 'sans',           		'length' => 1,	'default' => '',	'type' => 'text'),
...
//         if ($conf->agefodd->enabled && $conf->global->EXPORT_COMPTA_ADD_AGEFODD_PRESTA) $this->_format_ecritures_comptables_vente[] = array('name' => 'type_prestation',      'length' => 1,	'default' => '',	'type' => 'text');
        ...
        $this->_format_ecritures_comptables_vente[] = array('name' => 'mode_reglement',		'length' => 6,	'default' => '',	'type' => 'text');
        $this->_format_ecritures_comptables_vente[] = array('name' => 'libelle',				'length' => 35,	'default' => '',	'type' => 'text');
        // ---------------------------------------------------------
        ...
        foreach ($TabFactures as $id_facture => $infosFacture) {
            ...
            foreach($infosFacture['ligne_produit'] as $code_compta => $montant) {
                ...
                if ($conf->agefodd->enabled) {
                    if($facture['type_session'] == '0') $ligneFichier['type_prestation'] = 'P';
                    elseif($facture['type_session'] == '1') $ligneFichier['type_prestation'] = 'F';
                }
